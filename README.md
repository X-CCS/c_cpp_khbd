...
=================
   ...
   * [C/C  面试宝典](#cc面试宝典)
      * [<strong>1. 常识概念题</strong>](#1-常识概念题)
         * [1.1 面向对象的三大特点](#11-面向对象的三大特点)
         * [1.2 结构体和类的区别](#12-结构体和类的区别)
         * [1.3 空类占多少个字节](#13-空类占多少个字节)
         * [1.4 引用占用内存空间吗](#14-引用占用内存空间吗)
         * [1.5 公有继承和私有继承的区别](#15-公有继承和私有继承的区别)
         * [1.6 虚析构函数的作用](#16-虚析构函数的作用)
         * [1.7 C  强制类型转换有哪些](#17-c强制类型转换有哪些)
         * [1.8 重写(覆盖)和隐藏的区别](#18-重写覆盖和隐藏的区别)
         * [1.9 深拷贝和浅拷贝](#19-深拷贝和浅拷贝)
         * [1.10 标准模板库的vector是否能当作栈](#110-标准模板库的vector是否能当作栈)
      * [2 编程题](#2-编程题)
